...
const Info = () => {
  return (
    <div className='w-full font-spaceGrotesk'>
        <div className="w-full bg-white m-auto px-4 md:w-full lg:px-0 lg:flex lg:items-center lg:justify-center lg:gap-[400px] xl:py-4">
          <div className="container py-10 md:w-[680px] md:m-auto md:flex md:flex-col md:justify-between md:items-center md:mt-10 xl:w-11/12 xl:flex-row xl:m-auto xl:flex xl:items-center xl:justify-between">
          <div className="font-bold text-2xl text-center pb-2 md:text-start xl:text-start">
            ...
            <div className="text-center md:text-start xl:text-start xl:w-[515px]">
                <p className="pb-6 text-[#323F49] md:w-[500px] md:text-center xl:text-start xl:w-[500px] xl:text-xl xl:font-semibold">We are your partners in crafting digital brilliance. Our expertise spans UI/UX , mobile and website, web development, brand guidelines and product design.</p>
       ...
       <div className="w-full bg-[#034D2B] text-white m-auto">
        <h1 className="pt-8 pb-5 text-center font-medium text-3xl pt[71px] md:text-5xl md:pt-[71px] md:pb-8 xl:font-bold xl:text-[55px] xl:pt-[71px]">Why Choose Us ?</h1>
        ...
        <div className="w-full md:flex-col md:justify-between xl:flex lg:items-center xl:flex-row">
          <div className="px-4 xl:w-[554px] xl:px-0">
            <h1 className="text-center font-normal pb-3 text-2xl md:font-semibold md:text-3xl md:pb-2 xl:text-start xl:font-bold xl:text-[45px] xl:pb-6 xl:leading-10">Creative Visionaries, Innovative  And Passionate Entrepreneurs</h1>
