...
const NavBar = () => {
  ...
  return (
    <>
      <nav className=" bg-white top-0 w-full fixed border-b">
        <div className="max-w-7xl m-auto flex justify-between items-center p-5 lg:px-12 md:px-7">
          <div className="logo">
            <a href="/">
              {" "}
          ...
          <ul
            className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static  md:z-auto z-[-1]  w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in bg-white ${open ? "top-20 opacity-100" : "top-[-490px]"
              } md:opacity-100 `}
          >
            {NavLinks.map((link) => (
