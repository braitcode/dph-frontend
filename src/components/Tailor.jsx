...
const Tailor = () => {
    return (
        <div className='max-w-[1260px] w-11/12 mx-auto lg:w-10/12 xl:w-3/4 font-spaceGrotesk'>
            <section className='w-full p-4 pb-[5rem]'>
                <h2 className='font-bold text-[30px] leading-normal text-center pt-7 md:text-[38px] lg:text-[48px]'>
                    Tailored Solution For Your Needs
                </h2>
                <h5 className='text-[12px] text-center mt-2 font-medium text-[#565353] md:text-[16px] lg:text-[24px] block'>
                        ...
                        solution.map((sol) => {
                            ...
                            return (
                                <div key={id} className='bg-[#EFEFEF] pt-7 pb-7 pl-3 pr-3 rounded shadow-[0_1px_0_0] shadow-[#000000] lg:w-full lg:pl-6 group hover:bg-[#028A4C]'>
                                    ...
                                    <p className='text-[10px] font-medium group-hover:text-white md:text-[12px] lg:text-[16px]'>
                                        {description}
