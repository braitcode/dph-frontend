  ...
  return (
    <>
      <div>
        ...
        <div className="w-full md:flex justify-center items-center gap-12 md:mb-[2rem] p-5 mt-[5rem]">
          ...
          <div className="md:w-[45%] flex flex-col gap-[36px]">
            <div className="md:flex flex-col md:gap-[20px]">
              <h1 className="xl:text-[55px] text-[30px] md:text-[40px] font-bold font-spaceGrotesk lh-normal">
        ...
        <div className="flex justify-evenly bg-black text-white  p-5 py-6 md:py-5 font-spaceGrotesk xl:text-[32px] text-[10px] md:text-[19px] lg:px-12 md:px-7 ">
