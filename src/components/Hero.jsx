...
const Hero = () => {
  return (
    <>
      <div >
        {/* <NavBar /> */}
        <div className="w-full md:flex justify-center items-center gap-12 md:mb-[2rem] p-2 mt-[5rem] max-w-7xl m-auto ">
          {/* left div */}
          <div className="md:w-[45%] flex flex-col gap-[36px]">
            <div className="md:flex flex-col md:gap-[20px]">
              <h1 className="xl:text-[55px] text-[30px] md:text-[40px] font-bold font-spaceGrotesk leading-[3.2rem]">
                Elevate your brand with stunning mobile and website designs
              </h1>
              <p className="xl:text-[24px] text-[12px] md:text-[18px] font-medium font-spaceGrotesk lh-normal p-2 hidden md:block">
                Driven by a passion for innovative designs, we craft mobile and
                web designs that captivate and resonate with users.
              </p>
              <div className="xl:flex md:gap-3 hidden md:block">
          ...
          <div className="md:w-[45%] mt-3 ">
            <div className="flex justify-between  gap-3 py-3">
              <div className="relative z-[-2]">
                ...
                <div className="absolute xl:mt-[50px] top-[-15px] md:top-[-15px] left-12  md:left-[80px]">
              ...
              <div className="bg-[#F0F0F0] flex flex-col justify-center  rounded-xl text-center   font-spaceGrotesk  w-[350px]">
                <div className="w-full flex justify-center">
                  <div className="w-[80%]">
                    ...
                    <h1 className="xl:text-[84px] text-[40px] md:text-[30px] text-[#02864A] font-bold">
                      230+
                    </h1>
        ...
        <div className=" bg-black">
          <div className="flex justify-evenly text-white  p-5 py-6 md:py-5 font-spaceGrotesk xl:text-[32px] text-[10px] md:text-[19px] lg:px-12 md:px-7 max-w-7xl m-auto ">
