    ...
    <div>
      ...
      <div className="container m-auto xl:w-11/12 xl:border-2 xl:rounded-3xl mb-[71px]">
        <div className="flex flex-col xl:flex-row xl:w-11/12 xl:h-[660px] lg:gap-[62px] m-auto lg:mt-10">
          <div className="green mb-10 m-auto w-11/12 text-white rounded-3xl bg-[#034D2B] xl:mb-0 xl:w-2/5 xl:h-[660px]">
            <div className="xl:w-[344px] xl:pt-[44px] xl:m-auto">
              <h1 className='text-center pt-4 font-bold text-[28px] xl:text-start xl:pt-0'>Contact Information</h1>
              <p className='text-center px-4 pb-6 font-medium text-[16px] text-[#FFFFFF99] xl:text-start xl:px-0 xl:pb-0'>Fill up the form and our team will get back to you within 24 hours.</p>
            </div>
            {/* list */}
            <div className=" m-auto w-9/12 xl:w-[344px] xl:m-auto xl:flex xl:flex-col xl:gap-6 xl:mt-10">
              ...
              <div className="one pb-3 flex items-center gap-4 font-medium text-[20px] xl:pb-0 xl:gap-[25px">
                <img src={MiniLoc} alt="" />
                <p className='xl:w-[211px]'>444 St. Yellow Street California, Usa</p>
              </div>
            </div>
          ...
          <div className="bg-white xl:w-[700px] xl:mt-10 xl:h-[576px] w-full h-auto xl:rounded-xl ">
            <form onSubmit={handleSubmit(onSubmit)} className="w-10/12 m-auto flex flex-col gap-6 xl:w-full xl:m-0">
              <div className="flex flex-col sm:flex-row justify-between gap-4">
                <div className="w-full sm:w-[48%] flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className={`border-2 text-[14px] p-3 rounded-md font-spaceGrotesk ${errors.firstName ? 'border-red-500' : ''}`}
                ...
                <div className="w-full sm:w-[48%] flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className={`border-2 text-[14px] p-3 rounded-md font-spaceGrotesk ${errors.lastName ? 'border-red-500' : ''}`}
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-4">
                <div className="w-full sm:w-[48%] flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className={`border-2 text-[14px] p-3 rounded-md font-spaceGrotesk ${errors.email ? 'border-red-500' : ''}`}
                    {...register('email', {
                ...
                <div className="w-full sm:w-[48%] flex flex-col gap-2">
                  ...
                  <div className="flex">
                    <select
                      className={`border-2 border-t border-b rounded-l-md bg-gray-50 text-[14px] p-3 font-spaceGrotesk ${errors.countryCode ? 'border-red-500' : ''}`}
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className={`text-[14px] border-2 rounded-lg p-8 font-spaceGrotesk ${errors.message ? 'border-red-500' : ''}`}
                  rows="5"
